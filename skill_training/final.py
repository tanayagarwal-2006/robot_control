...
print("WARNING: Avoid using multiple commands in at once. Instead, use them one at a time.")
...
while True:
    ...
    if movement_data['Skills training mode']==True:
        skills.skills_training()

    if "Execute learned skill" in movement_data and movement_data["Execute learned skill"]:
        name_of_skill=movement_data['Execute learned skill']
        skills.execute_skill(name_of_skill)
